      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-2 md:col-span-1">
            <h2 className="text-2xl font-serif font-bold text-amber-900 mb-6">Lumina<span className="text-amber-600">Books</span></h2>
            <p className="text-gray-500 text-sm leading-relaxed mb-6">
              Curating stories that enlighten, entertain, and inspire since 2024. Your premium destination for literature.
            </p>
        ...
        <div className="pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-gray-400">&copy; 2024 Lumina Books. All rights reserved.</p>
