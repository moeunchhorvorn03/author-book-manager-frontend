        ...
        <section className="bg-amber-900 py-20 px-4">
            <div className="max-w-4xl mx-auto text-center">
                <h2 className="text-3xl sm:text-4xl font-serif font-bold text-white mb-6">
                    Meet Your <span className="text-amber-400">PowerBooks AI Assistant</span>
                </h2>
                <p className="text-amber-100 mb-10 text-lg">
                    Not sure what to read next? Tell our PowerBooks AI about your favorite
                    genres, books, or moods, and get curated recommendations instantly.
                </p>
                ...
                <div className="relative max-w-2xl mx-auto mb-10">
                    ...
                    <button
                        ...
                        className={`absolute right-2 top-2 bottom-2 px-6 rounded-full font-bold transition-all flex items-center gap-2 ${isLoading || !prompt.trim()
                ...
                {response && (
                    <div className="bg-white/5 border border-white/10 p-8 rounded-3xl text-left animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div className="text-amber-50 whitespace-pre-wrap font-serif text-lg">
